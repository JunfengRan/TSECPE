...
class Network(nn.Module):
    ...
    def forward(self, query, query_mask, query_seg, query_len, clause_len, emotion_pos, cause_pos, doc_len, adj, q_type, ec_true_pairs=None):
        ...
        pred_emo_cau = self.pred_emo_cau(doc_sents_h, query, emotion_pos, doc_len, clause_len, ec_true_pairs)
        if q_type == 'emo':
            return pred_emo
        if q_type == 'emo_cau':
            return pred_emo_cau
