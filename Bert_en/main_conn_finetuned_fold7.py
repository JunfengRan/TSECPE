...
if __name__ == '__main__':
    ...
    train_start1 = 1
    train_end1 = int(0.6 * dataset_len) + 1
    train_start2 = int(0.7 * dataset_len) + 1
    train_end2 = int(1 * dataset_len) + 1
    ...
    test_start = int(0.6 * dataset_len) + 1
    test_end = int(0.7 * dataset_len) + 1
