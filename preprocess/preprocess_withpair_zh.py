...
with open ('../data/pairs_zh.csv', 'w', encoding='utf-8', newline='') as f:
    ...
    while sec:
        ...
        for emo_clause_index in ec_emo_index:
            for i in range(length):
                ...
                # Write result in csv
                with open ('../data/pairs_zh.csv', 'a', encoding='utf-8', newline='') as g:
                    csv_writer = csv.writer(g)
                    csv_writer.writerow([pair_type, section, emo_clause_index, cau_candidate_index, emotion_clause, \
